...
`REST API` `WebSocket` `JWT Authentication` `Google OAuth`
`SQLAlchemy` `Alembic` `Layered Architecture`
...
`ERD` `Database Normalization` `Stored Procedure`
`Index Optimization` `ADO.NET` `pgvector`
...
`LoRA / QLoRA` `LLM API Integration` `RAG / Vector Search`
...
![Render](https://img.shields.io/badge/Supabase-3FCF8E?style=for-the-badge\&logo=Render\&logoColor=white)
![Render](https://img.shields.io/badge/Supabase-3FCF8E?style=for-the-badge\&logo=AWS\&logoColor=white)
...
**Email**
[pom159753@gmail.com](mailto:pom159753@gmail.com)
